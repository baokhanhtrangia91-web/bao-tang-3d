...
const ARTWORKS_POSITION = [
    ...
    { id: '15', w: 4, h: 5, x: 32.9, y: 4, z: -2, ry: -Math.PI / 2 },
    ...
    { id: 'm7', x: 36.7, y: 2.5, z: 5.9, ry: 0, scale: 2 },
    { id: 'm8', x: 36.9, y: 0, z: 15, ry: -Math.PI / 2, scale: 2.4 },
    { id: 'm9', x: 27.3, y: 1.5, z: -26, ry: 0, scale: 1.5 },
    { id: 'm10', x: 34.5, y: 1.5, z: -26, ry: Math.PI / 2, scale: 0.7 },
];
