...
export const artworkData = [
    ...
    // --- Tường bên phải (x = 9.8, quay về trái) ---
    ...
    // --- Tường sau (z = -14.8, quay về phía người dùng) ---
    { id: 7, title: 'Tác phẩm 7', image: '/images/art7.jpg', x: -4,   y: 2, z: -14.8, rotY: 0 },
    { id: 8, title: 'Tác phẩm 8', image: '/images/art8.jpg', x:  4,   y: 2, z: -14.8, rotY: 0 },
];
